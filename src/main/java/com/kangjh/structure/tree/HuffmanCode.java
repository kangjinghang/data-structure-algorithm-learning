...
//        System.out.println(new String(bytes));
    ...
    private static byte[] huffmanZip(byte[] bytes) {
        // 1.统计字节数组，生成node列表
        List<HuffmanNode> nodes = getNode(bytes);
...
//        }
    ...
    private static List<HuffmanNode> getNode(byte[] bytes) {
        // 1.创建一个ArrayList
